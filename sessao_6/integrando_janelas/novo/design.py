...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 780, 492))
        ...
        self.inputAbriArquivo = QtWidgets.QLineEdit(self.centralwidget)
        self.inputAbriArquivo.setObjectName("inputAbriArquivo")
        self.gridLayout.addWidget(self.inputAbriArquivo, 1, 0, 1, 4)
